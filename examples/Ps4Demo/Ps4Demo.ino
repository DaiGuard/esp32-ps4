...
void notify()
{
   ...
   if( abs(Ps4.event.analog_changed.button.up) ){
       Serial.print("Pressing the up button: ");
       Serial.println(Ps4.data.analog.button.up, DEC);
   }

   if( abs(Ps4.event.analog_changed.button.right) ){
       Serial.print("Pressing the right button: ");
       Serial.println(Ps4.data.analog.button.right, DEC);
   }

   if( abs(Ps4.event.analog_changed.button.down) ){
       Serial.print("Pressing the down button: ");
       Serial.println(Ps4.data.analog.button.down, DEC);
   }

   if( abs(Ps4.event.analog_changed.button.left) ){
       Serial.print("Pressing the left button: ");
       Serial.println(Ps4.data.analog.button.left, DEC);
   }

   //---------- Analog shoulder/trigger button events ----------
   if( abs(Ps4.event.analog_changed.button.l1)){
       Serial.print("Pressing the left shoulder button: ");
       Serial.println(Ps4.data.analog.button.l1, DEC);
   }

   if( abs(Ps4.event.analog_changed.button.r1) ){
       Serial.print("Pressing the right shoulder button: ");
       Serial.println(Ps4.data.analog.button.r1, DEC);
   }
   ...
   if( abs(Ps4.event.analog_changed.button.triangle)){
       Serial.print("Pressing the triangle button: ");
       Serial.println(Ps4.data.analog.button.triangle, DEC);
   }

   if( abs(Ps4.event.analog_changed.button.circle) ){
       Serial.print("Pressing the circle button: ");
       Serial.println(Ps4.data.analog.button.circle, DEC);
   }

   if( abs(Ps4.event.analog_changed.button.cross) ){
       Serial.print("Pressing the cross button: ");
       Serial.println(Ps4.data.analog.button.cross, DEC);
   }

   if( abs(Ps4.event.analog_changed.button.square) ){
       Serial.print("Pressing the square button: ");
       Serial.println(Ps4.data.analog.button.square, DEC);
   }
...
void loop()
{
    ...
    if( Ps4.data.button.select && Ps4.data.button.start )
