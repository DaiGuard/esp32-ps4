...
#define PS4_L2CAP_ID_HIDC 0x40
#define PS4_L2CAP_ID_HIDI 0x41
...
static void ps4_l2cap_init_service( char *name, uint16_t psm, uint8_t security_id);
static void ps4_l2cap_deinit_service( char *name, uint16_t psm );
...
void ps4_l2cap_init_services()
{
    ...
    ps4_l2cap_init_service( "PS4-HIDI", BT_PSM_HIDI, BTM_SEC_SERVICE_FIRST_EMPTY+1 );
}
